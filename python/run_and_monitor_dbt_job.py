...
project_id      = os.environ['DBT_JOB_ID'] # no default here, just throw an error here if id not provided
job_id          = os.environ['DBT_PROJECT_ID'] # no default here, just throw an error here if id not provided
